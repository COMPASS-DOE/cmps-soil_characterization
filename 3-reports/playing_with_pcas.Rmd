...
data_wide_PCA = data_combined_wide %>% dplyr::select(-c("dic", "gwc"))
...
pca_overall_upland = fit_pca_function(data_combined_wide_NO_DIC %>% filter(transect == "upland"))
pca_overall_transition = fit_pca_function(data_combined_wide_NO_DIC %>% filter(transect == "transition"))
pca_overall_wetland = fit_pca_function(data_combined_wide_NO_DIC %>% filter(transect == "wc"))
...
pca_upland_wle = fit_pca_function(data_combined_wide_NO_DIC %>% filter(transect == "upland" & region == "WLE"))
pca_upland_cb = fit_pca_function(data_combined_wide_NO_DIC %>% filter(transect == "upland" & region == "CB"))
...
pca_transition_wle = fit_pca_function(data_combined_wide_NO_DIC %>% filter(transect == "transition" & region == "WLE"))
pca_transition_cb = fit_pca_function(data_combined_wide_NO_DIC %>% filter(transect == "transition" & region == "CB"))
...
pca_wetland_wle = fit_pca_function(data_combined_wide_NO_DIC %>% filter(transect == "wc" & region == "WLE"))
pca_wetland_cb = fit_pca_function(data_combined_wide_NO_DIC %>% filter(transect == "wc" & region == "CB"))
